...
{
    [TestClass]
    public class CompanyBOffer_Test
    {
        ...
        public async Task GetOffer_Test(bool isSuccessTest, int expectedReturn)
        {
            ...
            var expectedAbsoluteUrl = "CompanyB/ProductOffer";
            var expectedMediaType = "application/json";
            var expectedRequest = "{\"Consignee\":\"AAA\",\"Consignor\":\"BBB\",\"Cartons\":[{\"Height\":10,\"Width\":5},{\"Height\":15,\"Width\":10}]}";
            var response = isSuccessTest ? GetHttpReponse() : GetHttpErrorReponse();
            var offer = new CompanyBOffer(_apiClient.Object);
